...
exports.blastDatabase = function (callback) {
  async.series([
    function (callback) {
      client.query("DROP DATABASE IF EXISTS " + conf.database, callback);
    },
    function (callback) { 
      client.query("CREATE DATABASE IF NOT EXISTS " + conf.database, callback);
    }
  ],
